...
(function(/*! Stitch !*/) {
        ...
        meta.onload = function() {
          ...
          routes = {
            ...
            "/galerie": function() {
              ...
              console.log(source);
              return $("article#galerie").html(source);
            },
            "/*": function(loc) {
...
}, "docs/albume": function(exports, require, module) {module.exports = "<h1>Albume</h1>\n\n<p><br><br></p>\n\n<h3>\n    <ul>\n        <li>Jeff Killed John and record deal (1998—2005)</li>\n        <br>\n        <li>The Poison (2005—2007)</li>\n        <br>\n        <li>Scream Aim Fire (2007—2008)</li>\n        <br>\n        <li>Fever (2009—2011)</li>\n    </ul>\n</h3>\n\n<h3>\n    <ul>\n        <li>Temper Temper (2011—present)</li>\n    </ul>\n</h3>\n\n<ul>\n<li>Breaking Point</li>\n<li>Truth Hurts</li>\n<li>Temper Temper</li>\n<li>P.O.W.</li>\n<li>Dirty little secret</li>\n<li>Leech</li>\n<li>Dead to the world</li>\n<li>Riot</li>\n<li>Saints &amp; Sinners</li>\n<li>Tears Don't Fall</li>\n<li>Livin' Life (On the Edge of a Knife)</li>\n<li>Not Invincible</li>\n<li>Whole Lotta Rosie</li>\n<li>Scream Aim Fire</li>\n</ul>"}, "docs/despre": function(exports, require, module) {module.exports = "<h1>Despre Trupa</h1>\n\n<p>Bullet For My Valentine este o trupă de Heavy metal înființată în Bridgend, Țara Galilor, în anul 1998 de către vocalistul Matthew Tuck. În prezent trupa este formată din: Matthew Tuck, Jason James, Michael Thomas și Michael Paget.</p>\n\n<p>Numele initial al trupei a fost Jeff Killed John, cei patru începându-și cariera muzicală cântând melodii ai celor de la Metallica si Nirvana. Jeff Killed John au compus șase melodii, care nu au fost niciodata lansate; doua dintre aceste melodii au fost rescrise și introduse în repertoriul \"Bullet For My Valentine\". Probleme financiare au reprezentat motivul pentru care trupa și-a schimbat numele, schimbând deasemenea și înclinația muzicală.</p>\n\n<p>Trupa a lansat primul album, The Poison, pe 3 octombrie 2005. The Poison cuprinde două dintre piesele ce au adus celebritatea trupei și anume \"All These Things I Hate (Revolve Around Me)\" și \"Tears Don't Fall\", pentru care au căpătat uneori și eticheta de trupă emo.</p>\n\n<p>Cel de-al doilea album de studio al trupei, Scream Aim Fire, a fost realizat pe 29 ianuarie 2008 si s-a clasat pe locul patru în Billboard 200. Urmǎtorul album, Fever, lansat pe 26 aprilie 2010, a debutat cu locul al treilea în același top și s-a vândut în peste un milion de exemplare în Statele Unite și în aproape 2.500.000 la nivel mondial, câștigând de asemenea trei premii Kerrang! pentru cea mai bună trupă din Marea Britanie.</p>\n\n<p><br><br></p>\n\n<div class=\"center\">\n    <figure class=\"center\">\n        <img src=\"/images/bwlogo.gif\" alt=\"\">\n    </figure>\n</div>"}, "docs/galerie": function(exports, require, module) {module.exports = ""}, "docs/home": function(exports, require, module) {module.exports = ""}, "helpers/DependenciesManager": function(exports, require, module) {(function() {
  ...
  LinkManager = (function(_super) {
    ...
    LinkManager.prototype.link = function(e) {
      ...
      el = this.getParentAnchor(e.target);
      console.log(el);
    ...
    LinkManager.prototype.linkAllAnchors = function() {
      ...
      for (_i = 0, _len = anchors.length; _i < _len; _i++) {
        anchor = anchors[_i];
        _results.push(anchor.addEventListener("click", this.link, false));
      }
      return _results;
    };
