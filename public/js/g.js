...
}, "docs/cutremure": function(exports, require, module) {module.exports = "<p><figure class=\"right\">\n    <img src=\"/images/quake.png\" alt=\"\"> <br />\n    <figcaption>Epicentrele Cutremurelor</figcaption>\n</figure></p>\n\n<h1>Cutremure</h1>\n\n<p>Cutremur sau seism sunt termenii folosiți pentru mișcările pământului, ce constau în vibrații originate în zonele interne ale Terrei, propagate în formă de unde prin roci. Aceste vibrații rezultă din mișcările plăcilor tectonice, fiind des cauzate de o activitate vulcanică.</p>\n\n<p>În unele țări, cuvântul cutremur este folosit doar pentru acele mișcări ale plăcilor tectonice care provoacă daune majore și seism sau mișcări seismice pentru cele care trec neobservate.</p>\n\n<p>Scara seismologică a lui Richter este o scală logaritmică, care este folosită pentru a evalua intensitatea cutremurelor.</p>\n\n<p><figure class=\"center\">\n    <a href=\"/images/sf.jpg\"><img src=\"/images/sf.jpg\" alt=\"\"></a>\n    <figcaption>Panorama foto San Francisco după cutremurul din 1906</figcaption>\n</figure></p>\n\n<p>Cutremure puternice ce devin catastrofe naturale, pot distruge construcții, clădiri, chiar localități întregi, provoacă alunecări de teren, chiar catastrofe naturale. Cutremurele submarine pot declanșa formarea de valuri uriașe până la 30 de m înățime atingând viteze neașteptate (800 km/h), astfel în Oceanul Pacific (Tsunami) a produs pagube foarte mari materiale, cu pierderi de vieți omenești. Știința care se ocupă cu studiul cutremurului (mișcărilor seismice) se numește seismologie.</p>\n\n<h4>Cutremurul în Istorie</h4>\n\n<p>Între secolul al V-lea î.Chr. și secolul al XIV-lea d.Chr, oamenii considerau că seismele sunt provocate, de regulă, de curenți de aer aflați în interiorul cavităților Pământului. Exista însă și ideea conform căreia cutremurele apăreau ca urmare a tensiunilor existente în scoarță între apă și pământ, idee avansată de filosoful grec Thales din Milet, în secolul al VI-lea î.Chr. Mai târziu, în prima sută de ani a erei noastre, Plinius cel Bătrân vorbea despre seisme ca fiind \"furtuni subpământene\".</p>\n\n<h4>Cutremurul de pământ</h4>\n\n<p>Prin studiul cutremurelor, la observatoarele seismice răspândite pe glob, cu ajutorul unui aparat de înregistrare a cutremurului s-a constatat că aceste mișcări ale scoarței pământului au un centru în adâncime de propagare circulară a undelor seismice. Punctul de la suprafață, (situat deasupra hipocentrului), în care se măsoară intensitatea cutremurului este numit epicentru. De aceea intensitatea cutremurului este definită nu numai de intensitatea și direcția de propagare a undelor, ci și de profunzimea hipocentrului (adâncimi măsurate până la 700 km).</p>\n\n<p>Intensitatea cutremurului, măsurată în epicentru, va fi cu atât mai mare cu cât hipocentrul este mai aproape de suprafață. La un cutremur se pot deosebi mișcări orizontale, verticale și de torsiune. În funcție de cauzele care le produc, se deosebesc: cutremure tectonice, cutremure vulcanice și cutremure de prăbușire.</p>\n\n<h4>Cauzele producerii cutremurelor</h4>\n\n<p>Cauzele producerii cutremurelor pot fi de două feluri:</p>\n\n<ol>\n<li>Naturale:\n<ul><li>deplasarea plăcilor tectonice</li>\n<li>erupții vulcanice</li>\n<li>impactul cu meteoriți</li></ul></li>\n<li>Antropice\n<ul><li>mijloacele de transport(produc minicutremure)</li>\n<li>explozii subterane antropice (de exemplu un test nuclear subteran)</li>\n<li>edificii care se surpă (mine abandonate de exemplu)</li></ul></li>\n</ol>\n\n<p>Anual se înregistrază circa 500.000 de mișcări seismice, însă doar 0,2% din ele pot provoca pagube.\nUrmări ale mișcărilor seismice: energia eliberată declanșază avalanșe și valuri seismice, produce modificări ale mediului natural și antropic în funcție de intensitatea și de modul de propagare a undelor, cu pierderi umane și economice.</p>\n\n<h4>Distribuția cutremurelor</h4>\n\n<p>Harta seismicității evidențiază teritoriile în care seismele se manifestă puternic și frecvent:\ncentura de foc a Pacificului, căreia îi revin circa 80% din cutremurele puternice globale și 90% din toată energia seismică anuală\nbrâul Mediteranean-Himalaian, care cuprinde și munții Carpați cu zona seismogenă Vrancea</p>\n\n<p>Celelalte zone seismice, Oceanul Atlantic, partea interioară a Oceanului Pacific, Riftul Est-African ș.a. au o activitate seismică mai redusă.\nȚara cu cele mai frecvente cutremure este Japonia. Cele mai puternice cutremure din România își au focarul în munții Vrancei, fiind produse de mișcări ale scoarței terestre.</p>\n\n<p>Există și zone unde cutremurele nu se produc. Aceste zone, numite aseismice sunt următoarele: scutul baltic, canadian, brazilian, african, australian, platforma rusă, Groenlanda ș.a..</p>\n\n<h4>Producerea cutremurelor</h4>\n\n<p>În momentul în care se declanșează cutremurul, din epicentru, adică din punctul situat deasupra vatrei cutremurului, vor porni unde de șoc. Primele valuri care vor porni se numesc unde primare sau unde P. Acestea sunt valuri longitudinale, care se propagă asemănător cu undele sonore: produc mișcări în sens înainte – înapoi, în direcția de propagare. Undele primare sunt urmate de undele secundare, sau undele S. Sub efectul acestora, rocile se vor zgudui perpendicular pe direcția de mers. Al treilea tip de unde, undele de suprafață, provoacă unduirea solului și accentuează \nefectul distrugator al undelor secundare.</p>\n\n<ol>\n<li><p>Unda P :</p>\n\n<ul><li>este o undă longitudinală, de compresie</li>\n<li>determină mișcarea particulelor solului paralel cu direcția de propagare</li>\n<li>unda se deplasează prin compresie-dilatare în direcția de mers</li>\n<li>amplitudinea acestei unde este direct proporțională cu magnitudinea (energia cutremurului)</li>\n<li>este percepută la suprafață de către oameni ca pe o săltare, un mic șoc în plan vertical</li>\n<li>nu este periculoasă pentru structuri (clădiri) deoarece conține (transportă) aproximativ 20% din energia totală a cutremurului</li></ul></li>\n<li><p>Unda S :</p>\n\n<ul><li>este o undă transversală, de forfecare</li>\n<li>determină mișcarea particulelor solului perpendicular (transversal) față de direcția de propagare</li>\n<li>deplasarea acestei unde este similară cu înaintarea unui șarpe (mișcări ondulatorii stânga-dreapta față de direcția de înaintare)</li>\n<li>este resimțită la suprafață sub forma unei mișcări de forfecare, de balans în plan orizontal</li>\n<li>este periculoasă, deoarece transportă aproximativ 80% din energia totală a cutremurului</li>\n<li>determină distrugeri proporționale cu magnitudinea cutremurului și cu durata de oscilatie</li>\n<li>clădirile cad datorită intrării în rezonanță a frecvenței proprii de oscilație a structurii clădirii cu frecvența undei incidente, în acest caz efectul distructiv fiind puternic amplificat .</li></ul></li>\n</ol>\n\n<h4>Cele trei tipuri de margini</h4>\n\n<p>Munţii Himalaya, un exemplu de munți formați prin încrețire</p>\n\n<p>Suprafața globului este divizată în plăci tectonice. În timpul deplasării lor, acestea inevitabil vor întâlni alte plăci tectonice în cale. Când două plăci se întâlnesc, își lovesc și își deformează marginile astfel:</p>\n\n<ol>\n<li><p>Margini divergente</p>\n\n<p>Dacă se întâlnesc două plăci a căror margini sunt formate din crustă oceanică și care se mișcă depărtându-se una de alta, în spațiul care apare, iese la suprafață roca încinsă din manta, formându-se vulcani. Această rocă încinsă se răcește în apa oceanului, se întărește și duce la formarea unei noi cruste oceanice. Ea împinge cele două plăci forțându-le să se depărteze ducând la apariția cutremurelor în locul respectiv. Locul în care acest fenomen apare se numește zonă de divergență.</p></li>\n<li><p>Margini convergente</p>\n\n<p>Când două plăci se ciocnesc, o parte din marginile lor se distruge. Rezultatul acestor distrugeri depinde de tipul de cruste de la marginea plăcilor care se ciocnesc. Astfel: - daca se ciocnește o placă oceanică de una continentală, cea oceanică, fiind mai subțire și mai densă va fi forțată să intre sub cea continentală care este mai ușoară și mai groasă. Aici apare fenomenul de subducție . Crăpătura scoarței pe unde placa pătrunde în manta se numește fosă. -când se ciocnesc 2 plăci oceanice, de asemenea una poate fi împinsă sub cealaltă. -când se ciocnesc două plăci continentale, se creează arii de munți pentru că marginile care se ciocnesc se vor încreți, se vor compresa și vor fi împinse la suprafață. Acesta este procesul formării munților prin încrețire (ex.: Himalaya). Zona în care două plăci se ciocnesc se numește zonă de convergență.</p></li>\n<li><p>Când plăcile tectonice trec unele pe lângă altele ele vor aluneca, se vor lipi, se vor freca una de alta ducând la apariția unei presiuni care va face ca plăcile să se zdruncine, să se smucească formând cutremure.</p></li>\n</ol>"}, "docs/inundatii": function(exports, require, module) {module.exports = "<p><figure class=\"right\">\n    <img src=\"/images/nashville.jpg\" alt=\"\">\n    <figcaption>Inundaţie în oraşul Nashville</figcaption>\n</figure></p>\n\n<h1>Inundații</h1>\n\n<p>Inundatia este fenomenul de acoperire a terenului cu un strat de apa in stagnare sau miscare, care prin marimea si durata sa provoaca victime umane si distrugeri materiale ce deregleaza buna desfasurare a activitatilor social-economice din zona afectata.</p>\n\n<p>Inundatiile pot fi prevazute, cu exceptia celor instantanee, care se manifesta similar spargerii unui baraj. Astfel, acest tip de dezastru este precedat, de obicei, de intervale mari de prevenire. In functie de amploarea lor, inundatiile pot distruge imobile, poduri si recolte, pot ucide oameni, animale domestice si fauna.</p>\n\n<p>Sprijinul oferit populatiei afectate de inundatii de catre serviciile specializate ale autoritatilor si de voluntari inca din primele ore de la producerea dezastrului are ca obiective principale, intr-o prima faza, salvarea vietii oamenilor aflati in conditii de risc maxim prin actiuni de evacuare din zonele izolate/periculoase, acordarea primului ajutor si a serviciilor de asistenta de baza, si, in masura posibilitatilor, salvarea bunurilor materiale ale acestora. In faza urmatoare, se actioneaza pentru asigurarea asistentei victimelor in ceea ce priveste accesul la apa potabila, alimente de baza, adapost, salubritate, ingrijiri medicale de baza, prevenirea aparitiei si raspandirii epidemiilor.</p>\n\n<p>Coordonarea operatiunilor de interventie pentru limitarea consecintelor inundatiilor reprezinta o provocare specifica pentru serviciile de urgenta, deoarece, uneori, sunt acoperite de apa arii vaste de pamant, facand coordonarea foarte dificila. In aceste conditii, organizarea logisticii, transportului si distributiei ajutoarelor este dificila, cu atat mai mult cu cat, adesea, este deteriorata si infrastructura locala.</p>\n\n<p>Inundatiile ce se produc instantaneu (prin ruperea unui baraj/dig sau ploaie torentiala cu cantitate mare de apa pe unitatea de timp si suprafata) sunt provocate de volume extreme de apa ce apar brusc si curg rapid, acoperind mari suprafete.</p>\n\n<p>Datorita instalarii lor rapide, inundatiile instantanee sunt dificil de prevazut si le ofera oamenilor putin timp pentru a scapa in locuri mai inalte si a lua cu ei apa potabila, alimente, imbracaminte groasa, mijloace de comunicare si alte articole esentiale pentru asigurarea supravietuirii.</p>"}, "docs/seceta": function(exports, require, module) {module.exports = "<p><figure class=\"right\">\n    <img src=\"/images/lacsecat.jpg\" alt=\"\">\n    <figcaption>Fundul unui lac secat</figcaption>\n</figure></p>\n\n<h1>Seceta</h1>\n\n<p>Seceta este o stare extremă, caracterizată prin faptul că o anumită regiune suferă din cauza lipsei necesarului de apă. Seceta poate fi clasificată ca:</p>\n\n<ul>\n<li>Secetă meteorologică când domnește o perioadă mai lungă de timp lipsa completă a precipitațiilor sau când precipitațiile cad în cantități foarte mici.</li>\n<li>Secetă agricolă când există o cantitate insuficientă de apă necesară agriculturii (provenită din precipitații sau ape freatice)</li>\n<li>Secetă hidrogeologică când scade substanțial nivelul pânzei de ape freatice (rezervorul de apă subterană), nivelul apelor curgătoare și al celor stătătoare.</li>\n</ul>"}, "docs/tornade": function(exports, require, module) {module.exports = "<p><figure class=\"right\">\n    <img src=\"/images/tornadeusa.jpg\" alt=\"\">\n    <figcaption>Tornado, 1949 in Kansas (USA)</figcaption>\n</figure></p>\n\n<h1>Tornade</h1>\n\n<p>Tornado (span. tornar = a se întoarce,, participiu tornado; tornear = răsucire), sau Trombă puternică, vânt foarte puternic ce acționează pe un areal redus, sub formă de vârtej de aer fiind frecvent pe teritoriul Americii de Nord unde e numit și twister.\nVântul se rotește în atmosferă pe o axă verticală, fiind în corelație cu mișcările de convecție a aerului însoțit de nori negri de furtună (Cumulus și Cumulonimbus). Tromba vârtejului de aer se înalță de la suprafața pământului până la nivelul norilor, această definiție a lui Alfred Wegener (1917) este valabilă și azi.</p>\n\n<p><figure class=\"right\">\n    <img src=\"/images/f3.jpg\" alt=\"\">\n    <figcaption>Distrugerile unui Tornado-F3-(scara Fujita)</figcaption>\n</figure>\n<figure class=\"right\">\n    <img src=\"/images/imgtip.gif\" alt=\"\">\n    <figcaption>Imagine tipică a unei tornade detectată prin radar (Superzelle), aici se poate vedea cea mai puternică tornadă cu intensitatea (F5) care a acţionat în Oklahoma Tornado Outbreak în 1999</figcaption>\n</figure></p>\n\n<h3>Formare</h3>\n\n<p>Procesul de formare al vârtejului este complex, fiind azi încă în fază de cercetare, vântul ia naștere când anumite condiții climaterice sunt îndeplinite.\nFiind legate de anumite zone geografice și zile calendaristice. În Evul Mediu, ele erau considerate ca fiind „duhuri rele”.</p>\n\n<h3>Condiții de bază</h3>\n\n<p>Tornada se formează atunci când o cantitate imensă de aer cald (ciclon) urcă și aerul rece (anti ciclon) coboară, prin deplasare se formează o pâlnie. Din cauza încălzirii globale, au ajuns să se formeze tornade și în România.</p>\n\n<ul>\n<li>Convecția umedă este una din condiții, sub acțiunea acțiunii solare, și o sursă de energie fiind vaporii din atmosferă</li>\n<li>O anumită condiție atmosferică teobila care admite urcarea rapidă a aerului supraîncălzit, care suferă în straturile superioare de aer o răcire rapidă</li>\n<li>Un rol important îl joacă situația în care se află fronturile vecine de aer, paralel cu o convecție umedă unde răcirea se produce latent, are loc și o convecție uscată, această confruntare dintre cele două fronturi alcătuiesc formarea trombelor de vânt, care la început au o intensitate mică dar pot să crească la intensitatea unui tornado, care poate să dureze de la câteva secunde până la câteva ore.\nPână acum s-a măsurat la o tornada din Oklahoma la data de 3 mai 1999 la Bridge Creek, o intensitate de 496 ± 33 km/h, care pe scara Fujita corespunde gradului F-5.</li>\n<li><p>Aceste vânturi „bântuie” mai frecvent vara timpuriu, rol important îl are temperatura apei, formându-se deasupra oceanului o maximă care deasupra uscatului seara sau dimineața devreme se poate amplifica la intensitatea unui tornado.\nAceste furtuni se formează în regiunile subtropicale până în zonele cu climă temperată cu o frecvență mare în partea centrală SUA coasta Golfului Mexic.</p>\n\n<p>La fel apar în Argentina, Europa de est, Africa de Sud, Bengal, Japonia, insulele ce aparțin de Marea Britanie</p></li>\n</ul>"}, "docs/tsunami": function(exports, require, module) {module.exports = "<p><figure class=\"right\">\n    <img src=\"/images/aonang.jpg\" alt=\"\">\n    <figcaption>Tsunami afectând localitatea Ao Nang din Tailanda</figcaption>\n</figure>\n<figure class=\"right\">\n    <img src=\"/images/tsunamischema.png\" alt=\"\">\n    <figcaption>Reprezentarea schematică a unui tsunami</figcaption>\n</figure></p>\n\n<h1>Tsunami</h1>\n\n<p>Tsunamiul sau valul mareic reprezintă o undă energetică de tip mecanic ce se propagă prin apa oceanelor, ca urmare a producerii unor erupții subacvatice, sau și a unor cutremure submarine sau de coastă foarte puternice (7-9 grade pe scara Richter).</p>\n\n<h3>Cauze</h3>\n\n<ul>\n<li>Prăbușirea unor asteroizi în oceane.</li>\n<li>Seisme sau alunecări submarine.</li>\n<li>Dislocări abrupte de roci (de exemplu alunecarea bruscă în trecutul geologic a unei părți a insulei Réunion în ocean).</li>\n<li>Dislocări bruște de ghețari în oceane.</li>\n</ul>\n\n<h3>Propagare</h3>\n\n<p>Valul tsunami (din limba japoneză: val de port) se propagă diferit față de valul obișnuit. În larg, la ape adânci, valul mareic prezintă viteze foarte mari: de la 300 la 700 Km/h, și se propagă în toată masa apei (pe toata adâncimea oceanului), nu doar la suprafață ca valul obișnuit creat de vânturi. Înălțimea lui variază de la câteva zeci de centimetri până la câțiva metri. El se înalță spre coastă, căpătând aspectul unui mal teșit, măturând în continuare fundul oceanului, pentru ca la mal să se manifeste ca un zid de apă care năvălește pe uscat. Un tsunami poate provoca pe țărm în câteva minute victime umane numeroase și pagube majore.</p>\n\n<h3>Istorie</h3>\n\n<p>La 9 iulie 1958 a avut loc un cutremur de 7,5 grade pe scara Richter în Golful Lituya, Alaska, provocând un megatsunami cu înălțimea valului de apă de 520 metri. Acesta este cel mai mare tsunami cunoscut din istorie.</p>\n\n<div class=\"center\">\n    <figure class=\"center little\">\n        <img src=\"/images/tsu1.gif\" alt=\"\">\n        <figure>Simularea mişcării particulelor într-un val (în apă puţin adâncă)</figure>\n    </figure>\n    <figure class=\"center little\">\n        <img src=\"/images/tsu2.gif\" alt=\"\">\n        <figure>La mică adâncime, viteza de propagare şi lungimea de undă scad, iar amplitudinea creşte</figure>\n    </figure>\n    <figure class=\"center little\">\n        <img src=\"/images/tsu3.jpg\" alt=\"\">\n        <figure>Coasta care are o pantă abruptă provoacă valuri cu potenţial distructiv</figure>\n    </figure>\n    <figure class=\"center little\">\n        <img src=\"/images/tsu4.jpg\" alt=\"\">\n        <figure>O pantă mai puţin abruptă ajută la diminuarea puterii tsunamiului</figure>\n    </figure>\n</div>\n\n<p><br></p>\n\n<h3>Semne pe coastă la apariția unui tsunami</h3>\n\n<p>La început, apa oceanului se retrage ca din senin. La orizont apare un mic \"zid de apă\" sau \"vălurele\", dispuse unele peste altele, ce se reped spre uscat. Apa ocupă cu viteză spațiul gol creat, și intră cu viteză mare pe plajă.</p>"}, "docs/vulcani": function(exports, require, module) {module.exports = "<h1>Vulcani</h1>\n\n<p>Prin vulcan se înțelege atât formația geologică de formă conică formată prin erupția lavelor, cenușelor și gazelor dintr-un focar cu topituri magmatice situate în adâncime cât și deschizătura din scoarța terestră care emite rocă topită sau parțial topită (lava), cenușă și gaze. Deschizătura poate fi o crăpătură sau o gaură (mai mult sau puțin rotundă), caz în care se numește „crater”. O caldeiră este bazinul în formă de căldare format prin așezarea părții de sus a conului vulcanic, ea având uneori crăpături sau crater (e). </p>\n\n<p><figure class=\"right\">\n    <img src=\"/images/placa.png\" alt=\"\">\n    <figcaption>Formarea unui vulcan la marginea plăcilor continentale</figcaption>\n</figure></p>\n\n<h3>Geneza vulcanului</h3>\n\n<p>Globul terestru are mai multe straturi. Profunzimea fiecărui strat geologic este determinată de greutatea specifică a rocilor componente. Astfel în centru (miezul Terrei) se găsesc cele mai grele elemente care, prin procese fizico-chimice exoterme, ajung la temperaturi foarte ridicate (mii de grade Celsius), fapt ce determină topirea rocilor cu formare de gaze. Acest fenomen cauzează presiuni deosebit de mari, gazele cautând sa străpungă straturile de la suprafață. Rocile vecine magmei suferă procese de transformare, fiind numite roci metamorfice. </p>\n\n<p>Un vulcan se formează prin ridicarea scoarței, alcătuind „conul vulcanului”, sub presiunea gazelor și magmei (rocile topite). Materiile incandescente ies la suprafață printr-un crater (deschidere cu forme si diametre diferite). Un crater puțin adânc se numește pateră. </p>\n\n<p>Cu toate că vulcanii sunt în general asociați cu distrugere, ei au și unele efecte pozitive: minerale din adâncul Terrei fac ca pământul din jurul multor vulcani să fie foarte fertil; ei creează noi forme de teren pe fundul mărilor, iar studiul vulcanilor contribuie în mod semnificativ la înțelegerea noastră a interiorului Terrei. </p>\n\n<p><figure class=\"left\">\n    <img src=\"/images/rinjani.jpg\" alt=\"\">\n    <figcaption>Erupţia vulcanului cu descărcări electrice atmosferice Rinjani în anul 1994</figcaption>\n</figure></p>\n\n<h3>Erupție</h3>\n\n<p>Fenomenul ieșirii magmei la suprafață este denumit erupție și are loc acolo unde scoarța terestră opune cea mai mică rezistență. Acest punct de rezistență redusă este reprezentat de crăpăturile din scoarță sau de limitele dintre plăcile tectonice continentale (ex. vulcani din Indonezia, din Cercul de foc al Pacificului), sau vulcani din Islanda. </p>\n\n<p>Erupția vulcanului este însoțită de cutremure de pământ, erupție de gaze, cenușă, bombe vulcanice (fragmente rupte din crater) și lavă (vâscozitatea ei diferă după reacția acidă sau bazică a lavei) care se solidifica prin răcire. </p>\n\n<p>Erupțiile vulcanice sunt de două feluri:</p>\n\n<p><br></p>\n\n<ul>\n<li>erupția efuzivă este o erupție vulcanică silențioasă, care scoate la suprafață lava bazaltică cu viteză mică (erupțiile vulcanului Kilauea din Hawaii sunt efuzive). </li>\n<li>erupție explozivă este o erupție puternică a unui vulcan care aruncă în aer materia pe distanțe uriașe; lava e săracă în silicat; poate fi foarte periculoasă pentru locuitorii aflați în apropiere de locul erupției. </li>\n</ul>\n\n<p>Erupția incepe printr-un jet fierbinte de gaze si vapori de apa, insotit de materiale solide de diferite dimensiuni (cenusa, bombe vulcanice, blocuri), dupa care lava incandescenta incepe sa curga sub forma unortorenti sau a unor suvoaie de foc pe marginele craterului. \nDupa iesirea lavei, eruptia se linisteste, dar continua sa iasa gaze. La mult timp dupa incetarea eruptiei, activitatea vulcanicapoate continua cu emanatii de gaze reci (este cazul mofetelor din România) sau cu formarea de ghizere. Vulcanii pot fi stinsi sau activi. Cei din prima categorie se intalnesc si in Romania (Oas, Gutai). Vulcanii activi pot avea eruptii fracvente (Stromboli-Italia, Maua Loa-Hawaii)sau dimpotriva pot erupe dupa mari perioade de pauza (chiar secole, precum vulcanul Vezuviu din Italia).</p>\n\n<p><figure class=\"right\">\n    <img src=\"/images/hawaii.jpg\" alt=\"\">\n    <figcaption>Scurgere de lavă pe Hawaii</figcaption>\n</figure></p>\n\n<h3>Clasificare</h3>\n\n<ul>\n<li>După perioada de formare:\n<ul><li>vulcani tineri</li>\n<li>vulcani bătrâni</li></ul></li>\n<li>După activitate:\n<ul><li>vulcani activi, care continuă să erupă (ca. 600[2])</li>\n<li>vulcani inactivi (stinși), a căror activitate a încetat cu milenii în urmă și care nu mai au cameră magmatică</li>\n<li>vulcani adormiți, care nu au avut activitate o perioadă mai lungă de timp, de ordinul a sute sau chiar mii de ani, dar care au potențialul de a erupe în viitor. De regulă aceștia sunt cei mai periculoși și pot produce erupții de tip exploziv.</li></ul></li>\n<li>După tipul de manifestare a erupției:\n<ul><li>de tip islandic, cu erupții liniare de lave fluide, fără explozii</li>\n<li>de tip hawaian, cu erupții centrale liniștite de lave fluide</li>\n<li>de tip strombolian, cu erupții de lave fluide și explozii ritmice de gaze</li>\n<li>de tip vulcanian, cu erupții de lave vâscoase care, după consolidarea în coșul vulcanic, vor fi expulzate sub formă de cenușă și bombe vulcanice prin explozii puternice ale gazelor</li>\n<li>de tip peleean, cu erupții de lavă vâscoasă care se ridică în forma unui stâlp</li>\n<li>de tip Bandai-San, la care exploziile foarte puternice aruncă în aer vechiul aparat vulcanic.</li></ul></li>\n</ul>"}, "helpers/DependenciesManager": function(exports, require, module) {(function() {
